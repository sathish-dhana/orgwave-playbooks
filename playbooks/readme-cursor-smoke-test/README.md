...
**Add to Cursor:** Opens the **[MCP install](https://cursor.com/docs/context/mcp/install-links)** flow (prefilled name, command, env). Open **`orgwave-playbooks`** as the workspace folder first so paths like `${workspaceFolder}/orgwave/scripts/...` work. Fill secrets in the dialog or use **`.env`** / **`~/.cursor/*-mcp.env`** / **`~/.zshrc`** as in **[mcp-servers/README.md](../../mcp-servers/README.md)**.
